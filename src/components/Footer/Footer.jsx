...
const Footer = () => {
  return (
    ...
    <div className='footer-parent'>
      <div className='footer-parent-first'>
    ...
    <div className='footer-low'>
      ...
      <div className='flex-member'>
        <img src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/payment-method_69e7ec.svg" alt="logo" />
      </div>
    </div>
    </div>
  )
